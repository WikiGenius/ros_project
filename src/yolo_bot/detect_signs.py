...
class DetectSigns:
    ...
    def __init__(self):
        ...
        rospy.Subscriber('/camera/rgb/image_raw/compressed', CompressedImage, self._img_callback)
        self.pub_img_proj = rospy.Publisher('/camera/image_output/compressed', CompressedImage, queue_size=1)
        self.pub_sign = rospy.Publisher('/class_name', Int16, queue_size=1)
    ...
    def _img_callback(self, msg):
        ...
        self.pub_obs.publish(self.class_name)
...
if __name__ == '__main__':
    ...
    detect_signs.run(**vars(opt))

    # detect_signs.create_node()
